...
public class MaiorOuIgual implements Funcao {
	private Object itemDaEsquerda;
	private Object itemDaDireita;
	private Objeto resultado;
	
	public MaiorOuIgual(Object itemDaEsquerda, Object itemDaDireita) {
	...
	private Objeto executaComparacao(Objeto itemDaEsquerda, Objeto ItemDaDireita){
		if (verificaSeOsDoisItensSãoNumeros(itemDaEsquerda, ItemDaDireita)){
			...
			if (numeroDaEsquerda.equals(numeroDaDireita) || verificaSeNumeroDaEsquerdaÉMaiorQueODaDireita(numeroDaEsquerda, numeroDaDireita)){
	...
	private boolean verificaSeNumeroDaEsquerdaÉMaiorQueODaDireita(Numero numeroDaEsquerda, Numero numeroDaDireita) {
