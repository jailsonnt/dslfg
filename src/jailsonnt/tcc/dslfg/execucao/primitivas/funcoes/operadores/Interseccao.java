...
public class Interseccao implements Funcao {
	private String nomeConjuntoPrincipal;
	private String nomeConjuntoParaVerificar;
	private Objeto resultado;
	
	public Interseccao(String nomeConjuntoPrincipal, String nomeConjuntoParaVerificar){
	...
	public void executar(ContextoDeExecucao contextoDeExecução) throws ExcecaoEmTempoDeExecucao {
		...
		resultado = conjuntoPrincipal.obterIntersecçãoDeConjuntos(conjuntoParaVerificar);
	}
