...
public class Multiplicacao implements Funcao {
	private Objeto resultado;
	private Object itemDaDireita;
	private Object itemDaEsquerda;

	public Multiplicacao(Object itemDaEsquerda, Object itemDaDireita) {
	...
	public void executar(ContextoDeExecucao contextoDeExecução) throws ExcecaoEmTempoDeExecucao {
		...
		resultado = executaMultiplicação(itemDaEsquerda, itemDaDireita);
	...
	private Objeto executaMultiplicação(Objeto itemDaEsquerda, Objeto itemDaDireita){
