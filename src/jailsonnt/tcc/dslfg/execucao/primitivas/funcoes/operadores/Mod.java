...
public class Mod implements Funcao {
	private Objeto resultado;
	private Object itemDaDireita;
	private Object itemDaEsquerda;

	public Mod(Object itemDaEsquerda, Object itemDaDireita) {
	...
	public void executar(ContextoDeExecucao contextoDeExecução) throws ExcecaoEmTempoDeExecucao {
		...
		resultado = executaMod(itemDaEsquerda, itemDaDireita);
	...
	private Objeto executaMod(Objeto itemDaEsquerda, Objeto itemDaDireita){
