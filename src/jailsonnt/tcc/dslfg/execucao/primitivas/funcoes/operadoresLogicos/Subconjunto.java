...
public class Subconjunto implements Funcao {
	private String itemDaEsquerda;
	private String itemDaDireita;
	private Objeto resultado;
	
	public Subconjunto(String itemDaEsquerda, String itemDaDireita) {
	...
	public void executar(ContextoDeExecucao contextoDeExecução) throws ExcecaoEmTempoDeExecucao {
		...
		resultado = conjuntoDaEsquerda.subconjunto(conjuntoDaDireita);
	}
	...
	public Executavel obterCópia() {
		return new Subconjunto(itemDaEsquerda, itemDaDireita);
	}
